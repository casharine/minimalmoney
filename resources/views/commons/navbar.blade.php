...
<div class="container">
  {{--<div class="float-right">--}}
    <div class="row">
      <div class="col-sm-12">
        <nav class="navbar navbar-fixed-bottom navbar-dark bg-dark py-0 px-2">
          {{-- userページへのリンク --}}
          ...
          {{-- inputボタン--}}
          <div> <button type="button" class="navbar-toggler" data-toggle="collapse" data-toggle="tooltip" title="費用を入力"
              data-target="#nav-bar">
